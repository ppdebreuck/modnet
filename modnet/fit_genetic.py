...
class FitGenetic:
    ...
    def initialization_population(
        ...
        for i in range(0, 10):
            ...
            pop[i] = [individual.n_features, individual.n_neurons_first_layer, individual.fraction1, individual.fraction2, individual.fraction3, individual.activation, individual.loss, individual.xscale, individual.lr, individual.initial_batch_size]
        return self.pop
